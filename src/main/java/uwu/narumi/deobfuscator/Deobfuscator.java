...
public class Deobfuscator {
    ...
    public static class Builder {
        ...
        private Path input = new File("input.jar").toPath();
        private Path output = new File("output.jar").toPath();
        ...
        public Builder transformers(ArrayList<Transformer> transformers){
